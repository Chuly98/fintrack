...
function App() {
  ...
  useEffect(() => {
    // Detectar si el usuario abrió el enlace del correo de recuperación
  ...
  return (
    <div className="min-h-screen bg-[#121212] font-sans text-white flex flex-col justify-between">
      ...
      {!usuarioActual ? (
        ...
        /* APP PRINCIPAL (CUANDO HAY SESIÓN) */
        <>
          {/* NAVEGACIÓN */}
          ...
          <div className="bg-[#161b22] rounded-3xl border border-gray-700 shadow-2xl w-full max-w-md p-6 relative animate-fade-in">
            <div className="flex justify-between items-center mb-4 border-b border-gray-800 pb-3">
              <div>
                ...
                <p className="text-xs text-gray-400">Ingresa la nueva contraseña para tu cuenta</p>
              </div>
